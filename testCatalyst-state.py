...
scalar_0000vtk = TrivialProducer(registrationName="ippl_field")

# create a new 'Cell Data to Point Data'
cellDatatoPointData1 = CellDatatoPointData(registrationName='CellDatatoPointData1', Input=scalar_0000vtk.CellData["density"])
