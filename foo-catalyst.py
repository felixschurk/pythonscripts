...
renderView2.ViewSize = [1586, 464]
renderView2.AxesGrid = 'GridAxes3DActor'
renderView2.CenterOfRotation = [10.0, 10.0, 10.0]
renderView2.StereoType = 'Crystal Eyes'
renderView2.CameraPosition = [-3.6347096894719773, 31.850118920056858, 62.81875484169318]
renderView2.CameraFocalPoint = [10.000000000000005, 10.000000000000004, 9.999999999999993]
renderView2.CameraViewUp = [0.12942304485466166, 0.9276387105144746, -0.35033712080736074]
renderView2.CameraFocalDisk = 1.0
renderView2.CameraParallelScale = 18.40303983041932
...
cellDatatoPointData1Display = Show(cellDatatoPointData1, renderView2, 'UniformGridRepresentation')
...
rhoLUTColorBar = GetScalarBar(rhoLUT, renderView2)
...
pNG1.Writer.ImageResolution = [1586, 464]
